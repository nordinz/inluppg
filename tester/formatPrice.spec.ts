...
describe("rounds up to show two decimals", () => {
  it("should return '232.11 SEK' if input is 232.10542", () => {
    const res = roundPrice(232.10542, "SEK");
    expect(res).toBe(`232.11 SEK`);
  });

  it("should return '14.00 AWG' if input is 14", () => {
    const res = roundPrice(14, "AWG");
    expect(res).toBe(`14.00 AWG`);
  });
